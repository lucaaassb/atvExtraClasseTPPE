...
public class Particionamento {
    ...
    public void testeParticionamento1() {
        ...
        assertEquals(7, new app.Particionador(valores, 0, valores.length - 1).particionar());
    }
    ...
    public void testParticionamento2() {
        ...
        q = QuickSort.getInstancia(valores);
        assertEquals(4, new app.Particionador(valores, 0, valores.length - 1).particionar());
    }
    ...
    public void testParticionamento3() {
        ...
        q = QuickSort.getInstancia(valores);
        assertNotNull(q);
        assertEquals(16, new app.Particionador(valores, 0, valores.length - 1).particionar());
    }
}
